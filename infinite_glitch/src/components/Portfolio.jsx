...
export const portfolios = [
  ...
  },
  {
    ...
    "description": "An automated post scheduler that leverages LinkedIn and Twitter APIs to publish updates. Its standout feature is the integration of generative AI to create tailored post captions for each platform. Built with Node.js, TypeScript, and Express.js, this tool streamlines social media management with intelligent content generation. I actively use this tool in my day-to-day life to efficiently manage and optimize my social media presence.",
